...
class AddTransactionCubit extends Cubit<AddTransactionState> {
  AddTransactionCubit({ required this.manageTranasactionsRepo}) : super(AddTransactionInitial());
  ...
  Future<void> addTransaction({required TransactionEntity transactionEntity}) async {
    ...
    final result = manageTranasactionsRepo.addTransaction(transactionEntity: transactionEntity);
